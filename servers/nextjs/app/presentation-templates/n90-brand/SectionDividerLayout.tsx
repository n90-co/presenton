...
const sectionDividerSchema = z.object({
  ...
  backgroundImage: ImageSchema.default({
    __image_url__: '/n90-assets/images/blog-campaign-reviews.jpg',
...
const SectionDividerLayout: React.FC<SectionDividerLayoutProps> = ({ data: slideData }) => {
  const bgUrl = slideData?.backgroundImage?.__image_url__ || '/n90-assets/images/blog-campaign-reviews.jpg'
